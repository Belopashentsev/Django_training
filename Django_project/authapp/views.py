...
def profile(request):
    if request.method == "POST":
        ...
        user_profile = ShopClientProfileEditForm(
            request.POST, request.FILES, instance=request.user.shopclientprofile
        )
        ...
        user = ShopProfileForm(
            instance=request.user
        )  # обязательно добавить при редактировании
        user_profile = ShopClientProfileEditForm(
